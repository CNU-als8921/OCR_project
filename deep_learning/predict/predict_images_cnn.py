...
# 모델 로드
model = load_model(os.path.join(project_root, 'deep_learning/models/emnist_byclass_cnn_model.h5'))
...
mapping = load_mapping(os.path.join(project_root, 'deep_learning/data/emnist/emnist-byclass-mapping.txt'))
